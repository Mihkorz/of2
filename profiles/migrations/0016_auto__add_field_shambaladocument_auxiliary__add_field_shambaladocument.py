...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShambalaDocument.auxiliary'
        db.add_column(u'profiles_shambaladocument', 'auxiliary',
                      self.gf('django.db.models.fields.CharField')(default='illumina', max_length=100),
                      keep_default=False)

        # Adding field 'ShambalaDocument.log_scale'
        db.add_column(u'profiles_shambaladocument', 'log_scale',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShambalaDocument.auxiliary'
        db.delete_column(u'profiles_shambaladocument', 'auxiliary')

        # Deleting field 'ShambalaDocument.log_scale'
        db.delete_column(u'profiles_shambaladocument', 'log_scale')
    ...
    models = {
        ...
        u'profiles.illuminaprobetarget': {
            'Meta': {'object_name': 'IlluminaProbeTarget'},
            'PROBE_ID': ('django.db.models.fields.CharField', [], {'max_length': '250', 'db_index': 'True'}),
            'PROBE_SEQUENCE': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
            'TargetID': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        ...
        u'profiles.shambaladocument': {
            'Meta': {'object_name': 'ShambalaDocument'},
            'auxiliary': ('django.db.models.fields.CharField', [], {'default': "'illumina'", 'max_length': '100'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'shambala_doc'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'doc_type': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'document': ('django.db.models.fields.files.FileField', [], {'max_length': '300'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'log_scale': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'related_doc': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'bound_doc'", 'null': 'True', 'blank': 'True', 'to': u"orm['profiles.ShambalaDocument']"}),
            'row_num': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
            'sample_num': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'})
        }
    }
