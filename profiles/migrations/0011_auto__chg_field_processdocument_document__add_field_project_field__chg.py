...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProcessDocument.document'
        db.alter_column(u'profiles_processdocument', 'document', self.gf('django.db.models.fields.files.FileField')(max_length=300))
        # Adding field 'Project.field'
        db.add_column(u'profiles_project', 'field',
                      self.gf('django.db.models.fields.CharField')(default='sci', max_length=3),
                      keep_default=False)


        # Changing field 'Document.document'
        db.alter_column(u'profiles_document', 'document', self.gf('django.db.models.fields.files.FileField')(max_length=300))

    def backwards(self, orm):

        # Changing field 'ProcessDocument.document'
        db.alter_column(u'profiles_processdocument', 'document', self.gf('django.db.models.fields.files.FileField')(max_length=100))
        # Deleting field 'Project.field'
        db.delete_column(u'profiles_project', 'field')


        # Changing field 'Document.document'
        db.alter_column(u'profiles_document', 'document', self.gf('django.db.models.fields.files.FileField')(max_length=100))
