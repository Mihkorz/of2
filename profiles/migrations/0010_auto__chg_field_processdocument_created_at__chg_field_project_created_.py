...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProcessDocument.created_at'
        db.alter_column(u'profiles_processdocument', 'created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Project.created_at'
        db.alter_column(u'profiles_project', 'created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Document.created_at'
        db.alter_column(u'profiles_document', 'created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'ProcessDocument.created_at'
        db.alter_column(u'profiles_processdocument', 'created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Project.created_at'
        db.alter_column(u'profiles_project', 'created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Document.created_at'
        db.alter_column(u'profiles_document', 'created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
