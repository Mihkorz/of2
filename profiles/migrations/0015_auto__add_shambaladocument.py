...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ShambalaDocument'
        db.create_table(u'profiles_shambaladocument', (
            ...
            ('related_doc', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='bound_doc', null=True, blank=True, to=orm['profiles.ShambalaDocument'])),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='shambala_doc', null=True, to=orm['auth.User'])),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'profiles', ['ShambalaDocument'])


    def backwards(self, orm):
        # Deleting model 'ShambalaDocument'
        db.delete_table(u'profiles_shambaladocument')
