...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'profiles_processdocument', 'input_doc_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['profiles.Document']))
        # Adding unique constraint on 'ProcessDocument', fields ['input_doc']
        db.create_unique(u'profiles_processdocument', ['input_doc_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ProcessDocument', fields ['input_doc']
        db.delete_unique(u'profiles_processdocument', ['input_doc_id'])
