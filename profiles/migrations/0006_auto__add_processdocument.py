...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProcessDocument'
        db.create_table(u'profiles_processdocument', (
            ...
            ('input_doc', self.gf('django.db.models.fields.related.ForeignKey')(related_name='input_doc', to=orm['profiles.Document'])),
            ('output_doc', self.gf('django.db.models.fields.related.ForeignKey')(related_name='output_doc', to=orm['profiles.Document'])),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='created', null=True, to=orm['auth.User'])),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'profiles', ['ProcessDocument'])


    def backwards(self, orm):
        # Deleting model 'ProcessDocument'
        db.delete_table(u'profiles_processdocument')
    ...
    models = {
        ...
        u'profiles.processdocument': {
            ...
            'document': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'input_doc': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'input_doc'", 'to': u"orm['profiles.Document']"}),
            'output_doc': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'output_doc'", 'to': u"orm['profiles.Document']"}),
            'parameters': ('jsonfield.fields.JSONField', [], {'blank': 'True'})
        },
        u'profiles.profile': {
