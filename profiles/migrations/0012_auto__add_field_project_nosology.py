...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.nosology'
        db.add_column(u'profiles_project', 'nosology',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['medic.Nosology'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.nosology'
        db.delete_column(u'profiles_project', 'nosology_id')
