...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Document.parameters'
        db.alter_column(u'profiles_document', 'parameters', self.gf('jsonfield.fields.JSONField')())

        # Changing field 'Document.calculated_at'
        db.alter_column(u'profiles_document', 'calculated_at', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Document.parameters'
        db.alter_column(u'profiles_document', 'parameters', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Document.calculated_at'
        db.alter_column(u'profiles_document', 'calculated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
    ...
    models = {
        ...
        u'profiles.document': {
            ...
            'calculated_at': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
