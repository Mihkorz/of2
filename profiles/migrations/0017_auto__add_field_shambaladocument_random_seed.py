...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShambalaDocument.random_seed'
        db.add_column(u'profiles_shambaladocument', 'random_seed',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShambalaDocument.random_seed'
        db.delete_column(u'profiles_shambaladocument', 'random_seed')
