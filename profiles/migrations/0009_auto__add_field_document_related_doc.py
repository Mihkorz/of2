...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.related_doc'
        db.add_column(u'profiles_document', 'related_doc',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='process_doc', null=True, blank=True, to=orm['profiles.Document']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Document.related_doc'
        db.delete_column(u'profiles_document', 'related_doc_id')
