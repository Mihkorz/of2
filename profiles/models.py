...
class Document(models.Model):
    ...
    sample_num = models.IntegerField(verbose_name="Sample amount", blank=True, default=0)
    norm_num = models.IntegerField(verbose_name="Norm amount", blank=True, default=0)
