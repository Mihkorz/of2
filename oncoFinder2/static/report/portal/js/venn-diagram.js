...
function drawVennWithData(reportID, renderTo, tolltip, data){
     ...
     div.selectAll("g")
         ...
         .on("click", function(d, i){
             ...
             //rawDynamicTable(reportID, idx, tblRenderTo, path_gene, categories, organism, is_barplot, is_metabolic);
