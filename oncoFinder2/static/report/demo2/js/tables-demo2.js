...
function drawGeneChart(gene_name, file_name){
		...
		$.getJSON('/report-portal/demo2-genesboxplotjson/',
				{
			     'gene': gene_name,
			     },
			     function(data) { 
...
function showPathDetails(path_name, filename){
	...
	$.get("/report-portal/report/demo2-ajaxpathdetail/",
			{
		     pathway: path_name,
		     filename: filename,
...
function drawGeneTable(id, file_name){
	...
	var table = $('#'+id).DataTable( {
        ...
        "ajax": {'url':'/report-portal/demo2-genetablejson/',
        	     'type': 'GET',
        	     'data':{
        	            'file_name': file_name,
        	            },        	      
...
function drawPathwayTable(id, file_name1, file_name2, is_metabolic){
	...
	$('#'+id).DataTable( {
        ...
        "ajax": {'url':'/report-portal/demo2-pathwaytablejson/',
        	     'type': 'GET',
        	     'data':{
