...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PathwayGroup.doc_proc'
        db.add_column(u'report_pathwaygroup', 'doc_proc',
                      self.gf('django.db.models.fields.files.FileField')(default='w', max_length=300, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PathwayGroup.doc_proc'
        db.delete_column(u'report_pathwaygroup', 'doc_proc')
