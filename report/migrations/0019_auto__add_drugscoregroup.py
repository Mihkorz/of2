...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DrugScoreGroup'
        db.create_table(u'report_drugscoregroup', (
        ...
        db.send_create_signal(u'report', ['DrugScoreGroup'])


    def backwards(self, orm):
        # Deleting model 'DrugScoreGroup'
        db.delete_table(u'report_drugscoregroup')
