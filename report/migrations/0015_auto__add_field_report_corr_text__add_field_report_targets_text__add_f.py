...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Report.corr_text'
        db.add_column(u'report_report', 'corr_text',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Report.targets_text'
        db.add_column(u'report_report', 'targets_text',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Report.tf_text'
        db.add_column(u'report_report', 'tf_text',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Report.kinetic_text'
        db.add_column(u'report_report', 'kinetic_text',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Report.corr_text'
        db.delete_column(u'report_report', 'corr_text')

        # Deleting field 'Report.targets_text'
        db.delete_column(u'report_report', 'targets_text')

        # Deleting field 'Report.tf_text'
        db.delete_column(u'report_report', 'tf_text')

        # Deleting field 'Report.kinetic_text'
        db.delete_column(u'report_report', 'kinetic_text')
