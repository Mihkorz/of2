...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Report.compare_groups'
        db.add_column(u'report_report', 'compare_groups',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Report.compare_groups'
        db.delete_column(u'report_report', 'compare_groups')
