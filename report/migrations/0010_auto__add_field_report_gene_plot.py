...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Report.gene_plot'
        db.add_column(u'report_report', 'gene_plot',
                      self.gf('django.db.models.fields.CharField')(default='vulcano', max_length=15),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Report.gene_plot'
        db.delete_column(u'report_report', 'gene_plot')
