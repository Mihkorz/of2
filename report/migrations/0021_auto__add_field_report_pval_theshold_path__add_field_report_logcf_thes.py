...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Report.pval_theshold_path'
        db.add_column(u'report_report', 'pval_theshold_path',
                      self.gf('django.db.models.fields.FloatField')(default=0.05),
                      keep_default=False)

        # Adding field 'Report.logcf_theshold_path'
        db.add_column(u'report_report', 'logcf_theshold_path',
                      self.gf('django.db.models.fields.FloatField')(default=0.2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Report.pval_theshold_path'
        db.delete_column(u'report_report', 'pval_theshold_path')

        # Deleting field 'Report.logcf_theshold_path'
        db.delete_column(u'report_report', 'logcf_theshold_path')
    ...
    models = {
        ...
        u'report.drugscoregroup': {
            'Meta': {'object_name': 'DrugScoreGroup'},
            'document': ('django.db.models.fields.files.FileField', [], {'max_length': '300'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
            'report': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['report.Report']"})
        ...
        u'report.report': {
            ...
            'compare_groups': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'logcf_theshold_path': ('django.db.models.fields.FloatField', [], {'default': '0.2'}),
            ...
            'pval_theshold_path': ('django.db.models.fields.FloatField', [], {'default': '0.05'}),
