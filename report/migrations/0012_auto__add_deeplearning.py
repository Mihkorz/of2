...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DeepLearning'
        db.create_table(u'report_deeplearning', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('farmclass', self.gf('django.db.models.fields.files.FileField')(max_length=300)),
            ('sideeff', self.gf('django.db.models.fields.files.FileField')(max_length=300)),
            ('report', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['report.Report'])),
        ))
        db.send_create_signal(u'report', ['DeepLearning'])


    def backwards(self, orm):
        # Deleting model 'DeepLearning'
        db.delete_table(u'report_deeplearning')
    ...
    models = {
        u'report.deeplearning': {
            ...
            'sideeff': ('django.db.models.fields.files.FileField', [], {'max_length': '300'})
        },
        u'report.genegroup': {
