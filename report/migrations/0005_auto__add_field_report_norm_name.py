...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Report.norm_name'
        db.add_column(u'report_report', 'norm_name',
                      self.gf('django.db.models.fields.CharField')(default='est norm', max_length=250),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Report.norm_name'
        db.delete_column(u'report_report', 'norm_name')
