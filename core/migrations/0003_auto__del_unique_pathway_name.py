...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Pathway', fields ['name']
        db.delete_unique(u'core_pathway', ['name'])


    def backwards(self, orm):
        # Adding unique constraint on 'Pathway', fields ['name']
        db.create_unique(u'core_pathway', ['name'])
    ...
    models = {
        ...
        u'core.pathway': {
            'Meta': {'ordering': "['name']", 'unique_together': "(('name', 'database'),)", 'object_name': 'Pathway'},
