...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Gene', fields ['name', 'pathway']
        db.create_unique(u'core_gene', ['name', 'pathway_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Gene', fields ['name', 'pathway']
        db.delete_unique(u'core_gene', ['name', 'pathway_id'])
    ...
    models = {
        ...
        u'core.gene': {
            'Meta': {'ordering': "['name']", 'unique_together': "(('name', 'pathway'),)", 'object_name': 'Gene'},
        ...
        u'core.pathway': {
            ...
            'comment': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'database': ('django.db.models.fields.CharField', [], {'default': "'primary_new'", 'max_length': '20'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
