...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TreatmentNorms.is_active'
        db.add_column(u'medic_treatmentnorms', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'TreatmentMethod.percentage_response'
        db.alter_column(u'medic_treatmentmethod', 'percentage_response', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'TreatmentMethod.num_of_patients'
        db.alter_column(u'medic_treatmentmethod', 'num_of_patients', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'TreatmentMethod.accuracy'
        db.alter_column(u'medic_treatmentmethod', 'accuracy', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):
        # Deleting field 'TreatmentNorms.is_active'
        db.delete_column(u'medic_treatmentnorms', 'is_active')


        # Changing field 'TreatmentMethod.percentage_response'
        db.alter_column(u'medic_treatmentmethod', 'percentage_response', self.gf('django.db.models.fields.FloatField')(default=True))

        # Changing field 'TreatmentMethod.num_of_patients'
        db.alter_column(u'medic_treatmentmethod', 'num_of_patients', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'TreatmentMethod.accuracy'
        db.alter_column(u'medic_treatmentmethod', 'accuracy', self.gf('django.db.models.fields.FloatField')(default=0))
    ...
    models = {
        ...
        u'medic.treatmentmethod': {
            ...
            'num_of_patients': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'organization_name': ('django.db.models.fields.CharField', [], {'max_length': '250', 'blank': 'True'}),
            'percentage_response': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
