...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IlluminaProbeTarget'
        db.create_table(u'profiles_illuminaprobetarget', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('PROBE_ID', self.gf('django.db.models.fields.CharField')(max_length=250, db_index=True)),
            ('TargetID', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('PROBE_SEQUENCE', self.gf('django.db.models.fields.CharField')(max_length=250)),
        ))
        db.send_create_signal(u'profiles', ['IlluminaProbeTarget'])


    def backwards(self, orm):
        # Deleting model 'IlluminaProbeTarget'
        db.delete_table(u'profiles_illuminaprobetarget')
