...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'profiles_project', (
            ...
            ('viewed_at', self.gf('django.db.models.fields.DateTimeField')()),
            ('viewed_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='viewed', null=True, to=orm['auth.User'])),
        ))
        db.send_create_signal(u'profiles', ['Project'])

        # Adding M2M table for field members on 'Project'
        m2m_table_name = db.shorten_name(u'profiles_project_members')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('project', models.ForeignKey(orm[u'profiles.project'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'profiles_project_members'))
    ...
    models = {
        ...
        u'profiles.project': {
            ...
            'viewed_at': ('django.db.models.fields.DateTimeField', [], {}),
