...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProcessDocument.output_doc'
        db.alter_column(u'profiles_processdocument', 'output_doc_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['profiles.Document']))

        # Changing field 'ProcessDocument.input_doc'
        db.alter_column(u'profiles_processdocument', 'input_doc_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['profiles.Document']))

    def backwards(self, orm):

        # Changing field 'ProcessDocument.output_doc'
        db.alter_column(u'profiles_processdocument', 'output_doc_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['profiles.Document']))

        # Changing field 'ProcessDocument.input_doc'
        db.alter_column(u'profiles_processdocument', 'input_doc_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['profiles.Document']))
    ...
    models = {
        ...
        u'profiles.processdocument': {
            ...
            'document': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'input_doc': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'input_doc'", 'null': 'True', 'to': u"orm['profiles.Document']"}),
