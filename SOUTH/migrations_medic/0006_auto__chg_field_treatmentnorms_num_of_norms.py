...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TreatmentNorms.num_of_norms'
        db.alter_column(u'medic_treatmentnorms', 'num_of_norms', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'TreatmentNorms.num_of_norms'
        db.alter_column(u'medic_treatmentnorms', 'num_of_norms', self.gf('django.db.models.fields.IntegerField')(default=0))
